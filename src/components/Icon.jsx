const PATHS = {
  ...
  trophy: (
    <>
      ...
      <path d="M7.5 5.5H4.8A2.3 2.3 0 0 0 7 8.7M16.5 5.5h2.7A2.3 2.3 0 0 1 17 8.7" />
      <path d="M12 13v3.5M9 20.5h6M9.8 17h4.4l.5 3.5H9.3l.5-3.5z" />
    </>
  ),
  infinity: <path d="M7 9.5a3.5 3.5 0 1 0 0 7c2.6 0 3.5-2 5-3.5s2.4-3.5 5-3.5a3.5 3.5 0 1 1 0 7c-2.6 0-3.5-2-5-3.5s-2.4-3.5-5-3.5z" />,
  code: (
    <>
