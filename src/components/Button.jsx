...
const VARIANTS = {
  primary: 'bg-gradient-to-r from-teal-bright to-teal-deep text-on-brand shadow-[0_6px_20px_rgba(18,144,159,0.35)] hover:brightness-110',
  flat: 'bg-gradient-to-r from-teal-bright to-teal-deep text-on-brand shadow-[0_6px_20px_rgba(18,144,159,0.3)] hover:brightness-110',
